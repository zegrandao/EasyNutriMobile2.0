 ...
 *           'home-tab': {
 *             prefetchTemplate: false,
 *             templateUrl: "tabs-templates/startScreen.html",
            ...
            function ($scope, $attrs, $ionicSideMenuDelegate, $ionicPlatform, $ionicBody) {
                ...
                self.isDraggableTarget = function (e) {
                    ...
                    return ($scope.dragContent || self.isOpen()) &&
                        dragIsWithinBounds && !e.gesture.srcEvent.defaultPrevented && !e.target.tagName.match(/input|textarea|select|object|embed/i) && !e.target.isContentEditable && !(e.target.dataset ? e.target.dataset.preventScroll : e.target.getAttribute('data-prevent-scroll') == 'true');
                };
 ...
 * });
     ...
     * and then try to load startScreen.html into the `<ion-nav-view>`.
     *
     * Pages are loaded by the URLs given. One simple way to create templates in Angular is to put
     * them directly into your HTML file and use the `<script type="text/ng-template">` syntax.
     * So here is one way to put startScreen.html into our app:
     *
     * ```html
    ...
    IonicModule
        .directive('ionRefresher', ['$ionicBind', function ($ionicBind) {
            return {
                ...
                replace: true,
                require: '^$ionicScroll',
                template: '<div class="scroll-refresher" collection-repeat-ignore>' +
